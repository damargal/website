...
author:  "[David Martin-Galvez](https://github.com/damargal)"
date: "Sunday 9 April"
output:
  html_document:
    fig_width: 1
---
***
This is the website of David Martin-Galvez. I am a Doctor in Biology with post-doctoral research experience in Evolutionary biology, Behavioral ecology and more recently in Genomics. 
<br>
<br>
Currently I have a postdoctoral fellowship in the [European Bioinformatics Institute](http://www.ebi.ac.uk) at Hinxton in UK, working in the [Paul Flicek group](http://www.ebi.ac.uk/research/flicek).
